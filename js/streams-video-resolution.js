$(function () {
    ...
    selectResolution.onchange = function (e) {
        console.warn('CHANGE RESOLUTION');
        createStream();
    };

    function showCallArea() {
        console.warn('SHOW CALL AREA');
    ...
    function setCallListeners() {
        console.warn('SET CALL LISTENERS');
    ...
    var createStream = function () {
        ...
        console.warn(selectResolution.value);
